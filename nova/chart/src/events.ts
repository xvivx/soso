...
export type IframeReceiveRenderOptions = AppPostRenderOptions;
type IframeReceiveInitialEvent = AppPostInitialEvent;
type IframeReceivePaginationEvent = AppPostPaginationEvent;
type IframeReceiveDrawEvent = AppPostDrawEvent;
type IframeReceiveRenderEvent = AppPostRenderEvent;
type IframeReceiveSetThemeEvent = AppPostSetThemeEvent;
// iframe中接收到的事件
export type IframeReceiveEvent =
  | IframeReceiveInitialEvent
  | IframeReceivePaginationEvent
  | IframeReceiveDrawEvent
  | IframeReceiveRenderEvent
  | AppPostAddMarkerEvent
  | AppPostRemoveMarkerDrawEvent
  | AppPostPositionOrderEvent
  | AppPostPositionSpacingEvent
